...
class GoogleApiClient {
  ...
  Future<Attachment> createFile({
    ...
    String id;
    if (_assignmentFolder.id == null) {
      final assignmentFolder = await _driveApi.files.create(_assignmentFolder);
      id = assignmentFolder.id!;
    } else {
      id = _assignmentFolder.id!;
    }
  ...
  Future<drive.File> getOrCreateFolder(
    String folderName,
    String parentId,
  ) async {
    final query =
